...
import { Drawer, List, ListItem, ListItemIcon, ListItemText, Badge, Box, Collapse, Divider } from '@mui/material';
...
const Sidebar = () => {
    ...
    const handleVendorsProductClick = () => {
        setOpenVendorsProduct(!openVendorsProduct);
    };
    ...
    const menuItems = [
        ...
        { text: 'Orders', icon: <ShoppingCartIcon />, path: '/order-list' },
        {
            text: 'Customers',
            icon: <PeopleIcon />,
            subItems: [
        ...
        { text: 'Coupons', icon: <LocalOfferIcon />, path: '/view-coupons' },
        { text: 'Notifications', icon: <Badge badgeContent={unreadCount} color="error"><NotificationsIcon /></Badge>, path: '/view-notifications' },
        { text: 'Stores', icon: <StorefrontIcon />, path: '/view-stores' },
        { text: 'Sub Admins', icon: <AdminPanelSettingsIcon />, path: '/view-subadmin' },
        {
            text: 'Sellers',
            icon: <StorefrontIcon />,
            subItems: [
